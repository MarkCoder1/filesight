const EXTENSION_MAP: Record<string, string> = {
  png: 'images', jpg: 'images', jpeg: 'images', gif: 'images', webp: 'images', svg: 'images', ico: 'images', bmp: 'images',
  ...
  mp4: 'videos', mov: 'videos', avi: 'videos', mkv: 'videos', webm: 'videos', flv: 'videos', wmv: 'videos',
  mp3: 'audio', wav: 'audio', flac: 'audio', m4a: 'audio', ogg: 'audio', wma: 'audio', aac: 'audio',
  zip: 'archives', rar: 'archives', '7z': 'archives', tar: 'archives', gz: 'archives', bz2: 'archives', xz: 'archives',
  exe: 'installers', msi: 'installers', dmg: 'installers', pkg: 'installers', deb: 'installers', rpm: 'installers', appimage: 'installers',
};
